...
urlpatterns = [
    path('reg-alitqan-ister', views.createAdFirst, name='account_ad_first'),
    ...
    path('staff-profile', views.editProfileStaffSecond, name='profile_staff_second'),
    path('staff-user-profile', views.editProfileStaffThird, name='profile_staff_third'),
    path('student-edit-profile', views.editProfileStudentFirst, name='profile_student_first'),
    path('student-profile', views.editProfileStudentSecond, name='profile_student_second'),
    path('student-user-profile', views.editProfileStudentThird, name='profile_student_third'),
    ...
    path('staff/students-list', views.showStudentsSecond, name='staff_students_second'),
    path('staff/student-list', views.showStudentsThird, name='staff_students_third'),
    ...
    path('a---n-dashboard-second-term', views.showAdminBoardSecond, name='admin_board_second'),
    path('a---n-dashboard-third-term', views.showAdminBoardThird, name='admin_board_third'),
    path('staff-dashboard-first-term', views.showStaffBoardFirst, name='staff_board_first'),
    path('staff-dashboard-second-term', views.showStaffBoardSecond, name='staff_board_second'),
    path('staff-dashboard-third-term', views.showStaffBoardThird, name='staff_board_third'),
    path('student-dashboard-first-term', views.showStudentBoardFirst, name='student_board_first'),
    path('student-dashboard-second-term', views.showStudentBoardSecond, name='student_board_second'),
    path('student-dashboard-third-term', views.showStudentBoardThird, name='student_board_third'),
]
